      ...
      <nav className="sticky top-0 z-50 bg-white shadow-sm">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center">
            ...
            <span className="text-2xl font-bold text-blue-600 mr-16 ml-16">
              ELEZEA
            </span>
        ...
        <div className="flex flex-col md:flex-row md:items-center">
          ...
          <div className="w-full md:w-1/2 md:pr-4 text-left max-w-xl md:ml-24 md:self-center">
            ...
            <p className="text-base md:text-lg text-gray-600 mb-10">
              ELEZEA is an AI-powered language coach that sharpens your writing
              fluency through visual storytelling. Describe images, get instant
              feedback, and learn to think creatively in your target language.
            </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-10">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600">
              Get inspired by AI-generated or curated images perfect for
              language practice
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600">
              Write descriptions, stories, or dialogues - whatever sparks your
              creativity
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600">
              Receive instant AI feedback on grammar, vocabulary, and natural
              expression
            </p>
          </div>
        </div>
              ...
              >
                {lang.more ? (
                  ...
                  <>
                    ...
                    <span className="mt-2 text-gray-700 font-medium text-lg">
                      {lang.name}
                    </span>
                  </>
                )}
        ...
        <div className="container mx-auto grid md:grid-cols-3 gap-10 px-4">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-10 flex flex-col items-center">
            ...
            <p className="text-gray-600 text-lg text-left w-full">
              Describe captivating images in your target language, train your
              brain to think fluently, not just memorize.
            </p>
          </div>
          {/* Card 2 */}
          <div className="bg-white rounded-3xl shadow-lg p-10 flex flex-col items-center">
            ...
            <p className="text-gray-600 text-lg text-left w-full">
              Get instant scores and corrections on grammar, vocabulary, and
              style from Gemini AI—like a tutor in your pocket.
            </p>
          </div>
          {/* Card 3 */}
          <div className="bg-white rounded-3xl shadow-lg p-10 flex flex-col items-center">
            ...
            <p className="text-gray-600 text-lg text-left w-full">
              No drills. Just real-world practice: write descriptions, short
              stories, or even poetry based on visual prompts.
            </p>
          </div>
        </div>
          ...
          {faqData.map((faq, idx) => (
            <div key={faq.question} className="mb-6">
              ...
              {openFaq === idx && faq.answer && (
                <div className="text-gray-600 text-lg pb-4 pl-2 pr-8">
                  {faq.answer}
                </div>
              )}
      ...
      <footer className="bg-white-50 py-16 mt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-lg mb-8">
            ELEZEA is your AI writing coach that transforms how you learn
            languages through visual storytelling. Describe, create, and perfect
            your skills with real-time feedback - fluency has never felt this
            natural.
          </p>
